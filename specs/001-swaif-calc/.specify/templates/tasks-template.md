...
**Tests**: Tests are REQUIRED. Integration tests first, then unit tests, then implementation.
...
- [ ] T012 [P] [US1] Unit tests for [component] in tests/unit/test_[name].py
...
- [ ] T021 [P] [US2] Unit tests for [component] in tests/unit/test_[name].py
...
- [ ] T028 [P] [US3] Unit tests for [component] in tests/unit/test_[name].py
