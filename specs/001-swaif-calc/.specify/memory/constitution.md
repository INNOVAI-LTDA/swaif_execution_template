...
- Modified principles: Article I-IX expanded and formalized per Software Factory Constitution
- Added sections: Metadata, Preamble, Articles I-IX requirements/rationale, Amendment Process,
  Enforcement, Exception Process, Ratification, Appendix: Quick Reference
- Removed sections: Governance (prior summary) replaced by detailed Governance and Enforcement
...
- Emergency hotfixes (with retroactive documentation)
- Experimental prototypes (clearly labeled as non-production)
- One-off scripts (with explicit approval)
...
5. **Refine and Refactor**: Improve while keeping integration tests green
...
| 1.1.0 | 2026-02-26 | Expanded principles, gates, security, and documentation mandates | SWAIF Constitution Council |
